...
### The corresponding median for the steps taken per day is `r medianStepsPerDay`
...
```
### The interval, on average across all days with the maximum number of steps is `r result`
...
nrowsNA <- nrow(dataNA)
```
### The number of missing values in the dataset is `r nrowsNA`
